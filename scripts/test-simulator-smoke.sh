...
FEATURE_PROJECT_COUNT="${SMOKE_FEATURE_PROJECT_COUNT:-4}"
SWIFT_FILLERS_PER_FEATURE="${SMOKE_SWIFT_FILLERS_PER_FEATURE:-96}"
OBJC_FILLERS_PER_FEATURE="${SMOKE_OBJC_FILLERS_PER_FEATURE:-24}"
